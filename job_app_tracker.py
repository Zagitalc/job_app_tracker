    ...
    try:
        ...
        for msg in messages:
            ...
            if 'data' in msg_detail.get('payload', {}).get('body', {}):
                try:
                    body = base64.urlsafe_b64decode(msg_detail['payload']['body']['data'].encode('ASCII')).decode('utf-8')
                except Exception as e:
...
def parse_email(email):
    ...
    job_keywords = ["software engineer", "developer", "engineer", "data scientist", "manager", "designer", "qa"]
    job_title = None
...
def main():
    ...
    headers = ["Company", "Job Title", "Date of Application", "Rejection Stage", "Next Steps/Reply Status", "Notes"]
